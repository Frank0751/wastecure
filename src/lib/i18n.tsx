...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "hero.badge": "Ghana's Plastic Waste Solution",
    "hero.title1": "Curing Waste.",
    "hero.title2": "Healing the Planet.",
    ...
    "offer.title": "A responsible place for plastic waste",
    "offer.subtitle":
      "We give households, businesses and institutions across Kwabre East a real, sustainable option for plastic waste - backed by education and a recycling-first approach.",
